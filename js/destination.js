(function(){
    console.log("vive Javascript");
        ...
        const categories__ul__li = document.querySelectorAll(".categorie__ul__li");
        console.log("categorie__ul__li.length", categories__ul__li.length)
        categories__ul__li.forEach(li => {
